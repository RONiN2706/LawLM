...
st.set_page_config(page_title="LawLM — Sign Up", page_icon="⚖️", layout="centered")
...
.lx-logo-row{ display:flex; flex-direction:column; align-items:center; gap:10px; margin-bottom:1.4rem; }
.lx-logo-badge{
